...
const Hero = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center pt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-cover bg-top top-[-200px]" // Alterado de bg-center para bg-top
    style={{
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="absolute bottom-10 left-0 right-0 text-center">
            <div className="flex justify-center animate-bounce">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-detective-red">
